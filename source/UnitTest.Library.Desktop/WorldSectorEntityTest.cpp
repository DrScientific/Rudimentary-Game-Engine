...
namespace UnitTestLibraryDesktop
{
	...
	public:
		...
		TEST_METHOD(WorldNameAndAwakeTest)
		{
			...
			Assert::IsFalse(world.IsAwake());
			world.Wake();
			Assert::IsTrue(world.IsAwake());
			world.Sleep();
			Assert::IsFalse(world.IsAwake());
			world.SetIsAwake(true);
			Assert::IsTrue(world.IsAwake());
			world.SetIsAwake(false);
			Assert::IsFalse(world.IsAwake());
		}
		...
		TEST_METHOD(WorldCreateSectorsTest)
		{
			...
			Sector & sectorA = world.CreateSector("Sector A", "Sector");
			Sector & sectorB = world.CreateSector("Sector B", "Sector");
			Sector & sectorC = world.CreateSector("Sector C", "Sector");
			Sector & sectorD = world.CreateSector("Sector D", "Sector");
		...
		TEST_METHOD(GetAndSetParentTest)
		{
			...
			Sector & sector1A = world1.CreateSector("Sector 1A", "Sector");
			Sector & sector1B = world1.CreateSector("Sector 1B", "Sector");
			Sector & sector1C = world1.CreateSector("Sector 1C", "Sector");
			Sector & sector1D = world1.CreateSector("Sector 1D", "Sector");
			...
			Sector & sector2A = world2.CreateSector("Sector 2A", "Sector");
			Sector & sector2B = world2.CreateSector("Sector 2B", "Sector");
			Sector & sector2C = world2.CreateSector("Sector 2C", "Sector");
			Sector & sector2D = world2.CreateSector("Sector 2D", "Sector");
		...
		TEST_METHOD(WorldParseTest)
		{
			...
			*/
			...
			Sector & sectorA = static_cast<Sector&>(ourWorld["Sectors"][0]["Sector A"][0]);
			Entity & entityA1 = static_cast<Entity&>(sectorA["Entities"][0]["Entity A1"][0]);
			Entity & entityA2 = static_cast<Entity&>(sectorA["Entities"][1]["Entity A2"][0]);
			Entity & entityA3 = static_cast<Entity&>(sectorA["Entities"][2]["Entity A3"][0]);
			Entity & entityA4 = static_cast<Entity&>(sectorA["Entities"][3]["Entity A4"][0]);

			Sector & sectorB = static_cast<Sector&>(ourWorld["Sectors"][1]["Sector B"][0]);
			Entity & entityB1 = static_cast<Entity&>(sectorB["Entities"][0]["Entity B1"][0]);
			Entity & entityB2 = static_cast<Entity&>(sectorB["Entities"][1]["Entity B2"][0]);
			Entity & entityB3 = static_cast<Entity&>(sectorB["Entities"][2]["Entity B3"][0]);
			Entity & entityB4 = static_cast<Entity&>(sectorB["Entities"][3]["Entity B4"][0]);

			Sector & sectorC = static_cast<Sector&>(ourWorld["Sectors"][2]["Sector C"][0]);
			Entity & entityC1 = static_cast<Entity&>(sectorC["Entities"][0]["Entity C1"][0]);
			Entity & entityC2 = static_cast<Entity&>(sectorC["Entities"][1]["Entity C2"][0]);
			Entity & entityC3 = static_cast<Entity&>(sectorC["Entities"][2]["Entity C3"][0]);
			Entity & entityC4 = static_cast<Entity&>(sectorC["Entities"][3]["Entity C4"][0]);

			Sector & sectorD = static_cast<Sector&>(ourWorld["Sectors"][3]["Sector D"][0]);
			Entity & entityD1 = static_cast<Entity&>(sectorD["Entities"][0]["Entity D1"][0]);
			Entity & entityD2 = static_cast<Entity&>(sectorD["Entities"][1]["Entity D2"][0]);
			Entity & entityD3 = static_cast<Entity&>(sectorD["Entities"][2]["Entity D3"][0]);
			Entity & entityD4 = static_cast<Entity&>(sectorD["Entities"][3]["Entity D4"][0]);
			...
			Assert::IsTrue(ourWorld.IsAwake());
